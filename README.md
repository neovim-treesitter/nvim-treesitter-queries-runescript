# nvim-treesitter-queries-runescript

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-runescript/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-runescript/actions/workflows/validate.yml)

Neovim tree-sitter queries for **runescript**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-runescript",
...
- [ ] Changes are scoped to `runescript` — do not include files for other languages
